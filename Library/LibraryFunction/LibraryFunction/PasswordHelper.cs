...
namespace LibraryFunction
{
    public static class PasswordHelper
    {
            ...
            char[][] charGroups = new char[][]
        {
            ...
            string newPassword = RandomString(length - maxLength) + new string(password);
            // Convert password characters into a string and return the result.
            return newPassword;
        }

        public static string HashString(string code, string id)
        {
            //Declarations
            var sha = SHA256.Create();

            var originalBytes = Encoding.Default.GetBytes(code + CreateSalt(id));
