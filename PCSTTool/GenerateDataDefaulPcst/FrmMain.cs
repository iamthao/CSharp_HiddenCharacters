...
namespace GenerateDataDefaulPcst
{
    public partial class FrmMain : Form
    {
        ...
        private void WorkerOnDoWork(object sender, DoWorkEventArgs doWorkEventArgs)
        {
            ...
            if (ckProviderAgency.Checked)
            {
                RunProviderAgency();
            }
            if (ckProviderMpi.Checked)
            {
                RunProviderMpi();
            }
        }
            ...
            using (var mysqlProvider = new MySqlDataProvider(_connectionString))
            {
                ...
                if (total > Take)
                {
                    while (_skip < total)
                    {
                        ...
                        table = mysqlProvider.GetDataTable(script);
                        GenerateScriptHelper.SaveSqliteDb(ScriptSqliteHelper.TablePhysicanNpi, txtSaveSQLiteFile.Text);
        ...
        private void RunProviderAgency()
        {
            ckProviderAgency.BackColor = SystemColors.MenuHighlight;
            using (var mysqlProvider = new MySqlDataProvider(_connectionString))
            {
                string script, strScriptSqlite;
                DataTable table;
                ...
                if (total > Take)
                {
                    while (_skip < total)
                    {
                        ...
                        table = mysqlProvider.GetDataTable(script);
                        GenerateScriptHelper.SaveSqliteDb(ScriptSqliteHelper.TableProviderAgency, txtSaveSQLiteFile.Text);
            ...
            ckProviderAgency.BackColor = SystemColors.Control;
        }

        private void RunProviderMpi()
        {
            ckProviderMpi.BackColor = SystemColors.MenuHighlight;
            using (var mysqlProvider = new MySqlDataProvider(_connectionString))
            {
                string script, strScriptSqlite;
                DataTable table;
                ...
                if (total > Take)
                {
                    while (_skip < total)
                    {
                        ...
                        table = mysqlProvider.GetDataTable(script);
                        GenerateScriptHelper.SaveSqliteDb(ScriptSqliteHelper.TableProviderMpi, txtSaveSQLiteFile.Text);
            ...
            ckProviderMpi.BackColor = SystemColors.Control;
        }
