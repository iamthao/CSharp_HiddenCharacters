...
namespace Test
{
    class MergePdf
    {
        public static byte[] CombineMultiplePdfsByByte( List<byte[]> byteFiles)
        {
        ...
        public static void CombineMultiplePdfsByByteAndExport( List<byte[]> byteFiles, string desPath)
        {
            var document = new Document(PageSize.A4, 0, 0, 0, 0);
            var readerList = new List<PdfReader>();
