...
namespace UpgradeStringVersion
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var verOld = "1.0.0.0";
            //Console.WriteLine("Success!!" + verNew);

            Console.WriteLine("Enter x to exit");
            string line;
            while ((line = Console.ReadLine()) != "x")
            {
                Console.WriteLine(UpgradeVersionText(line));
            }
        }

        private static string UpgradeVersionText(string verOld)
        {
            var verNew = "1.0.0.0";
